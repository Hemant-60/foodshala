...
<?php
//Login verification
  if(isset($_POST['restro_login'])){
    $email=$_POST['login_email'];
    $pass=$_POST['login_pass'];
    $query="SELECT * FROM `restro` WHERE email='$email' and pass='$pass'";
    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <div class="container login-container">
          <h2><span class="badge badge-danger">Restaurants</span></h2>
                    <div class="row">
                        <div class="col-md-6 login-form-1">
                            <h3>Login</h3>
                            <form method="post" action="restro.php">
                                <div class="form-group">
                                    <input type="text" name="login_email" class="form-control" placeholder="Your Email *" value="" />
                                </div>
                                <div class="form-group">
                                    <input type="password" name="login_pass" class="form-control" placeholder="Your Password *" value="" />
                                </div>
                                <div class="form-group">
                                    <input type="submit" name="restro_login" class="btnSubmit" value="Login" />
                                </div>
                            </form>
                        </div>
                        <div class="col-md-6 login-form-2">
                            <h3>Signup</h3>
                            <form method="post" action="restro_signup.php">
                              <div class="form-group">
