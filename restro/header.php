...
<?php
  ...
  $id=$_SESSION['id'];
  $type=$_SESSION['type'];
  $fetchName=mysqli_query($conn,"SELECT * FROM restro where id='$id'");

  while($fetchRestroName=mysqli_fetch_array($fetchName)){
      $name=$fetchRestroName['name'];
  }
?>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="order.php">Orders
